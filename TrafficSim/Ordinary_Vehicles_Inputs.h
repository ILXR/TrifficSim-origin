...
#include "ui_Ordinary_Vehicles_Inputs.h"
#include "Com_use.h"

class Ordinary_Vehicles_Inputs :
	public QMainWindow
{
	Q_OBJECT

public:
	Ordinary_Vehicles_Inputs(QWidget *parent = Q_NULLPTR);
	~Ordinary_Vehicles_Inputs();

private:
	Ui::Ordinary_Vehicles_InputsClass ui;
